# Generated by Django 3.0.6 on 2020-06-08 05:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='django_taskflow.Element')),
                ('operator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('ticket', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='django_taskflow.Ticket')),
            ],
        ),
        migrations.CreateModel(
            name='Link',
